...
import { HandleLogout } from "../../../apiFuncHelper"
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <img src={`http://localhost:3000/assets/profilePic/${userDetails?.image}`} alt="User" className="h-full w-full object-cover" />
        </span>
      ...
      >
        ...
        <Link to="/signin" onClick={() => HandleLogout()} className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300" >
