          ...
          <div>
            ...
            <form>
              <div className="space-y-5">
                ...
                {/* <!-- Button --> */}
                <div>
                  <button onClick={(e)=>handelSignUp(e)} className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                    Sign Up
                  </button>
                </div>
              </div>
